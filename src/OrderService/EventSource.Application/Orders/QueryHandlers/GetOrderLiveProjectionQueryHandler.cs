...
public class GetOrderLiveProjectionQueryHandler : IRequestHandler<GetOrderLiveProjectionCommand, OrderStatusReadModel>
{
    ...
    public GetOrderLiveProjectionQueryHandler(IOrderAggregateQueryableRepository orderStreamRepository, IOrderQueryableRepository orderRepository)
    {
